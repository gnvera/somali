        ...
        <div class="row mt-3 white-text">
          ...
          <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
            <h5 class="text-uppercase font-weight-bold">Contacto</h5>
              <hr class="teal accent-3 mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;">
              <p>
                <i class="fa fa-location-arrow" aria-hidden="true"></i>&nbsp;Xóchitl 4313, El Zapote, 45040. Zapopan, Jalisco
              </p>

              <p>
                <i class="fa fa-envelope-o" aria-hidden="true"></i>&nbsp;somaliventas@gmail.com
              </p>
              <p>
                <i class="fa fa-phone" aria-hidden="true"></i> + 01 234 567 88
              </p>
              <p>
                <i class="fa fa-mobile" aria-hidden="true"></i> + 01 234 567 89
              </p>
            </div>
